            ...
            <div className="min-h-screen relative pb-20 pt-20 px-12 md:px-20">
                ...
                <div className="max-w-6xl mx-auto text-center relative z-20">
                    ...
                    <div className="md:hidden relative py-8 flex items-center justify-center gap-4 z-20">
                        <button onClick={handlePrev} className="text-5xl cursor-pointer transition-all duration-300 flex-shrink-0 hover:scale-125 active:scale-95 bg-transparent border-none z-30 relative" style={{ color: '#5CE1E6' }}>‹</button>
                        ...
                        <button onClick={handleNext} className="text-5xl cursor-pointer transition-all duration-300 flex-shrink-0 hover:scale-125 active:scale-95 bg-transparent border-none z-30 relative" style={{ color: '#5CE1E6' }}>›</button>
                    </div>
